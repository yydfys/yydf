...
class Spider(Spider):  # 元类 默认的元类 type
	...
	def homeVideoContent(self):
		rsp = self.fetch("https://www.voflix.me/",headers=self.header)
	...
	def categoryContent(self,tid,pg,filter,extend):
		...
		suffix = '-'.join(params)
		url = 'https://www.voflix.me/show/{0}.html'.format(suffix)
	...
	def detailContent(self,array):
		tid = array[0]
		url = 'https://www.voflix.me/detail/{0}.html'.format(tid)
		rsp = self.fetch(url,headers=self.header)
		root = self.html(rsp.text)
	...
	def searchContent(self,key,quick):
		url = "https://www.voflix.me/index.php/ajax/suggest?mid=1&wd={0}".format(key)
		rsp = self.fetch(url,headers=self.header)
	...
	def playerContent(self,flag,id,vipFlags):
		...
		result = {}
		url = 'https://www.voflix.me/play/{0}.html'.format(id)
		rsp = self.fetch(url,headers=self.header)
		root = self.html(rsp.text)
